...
// Booking Routes
router.post('/bookings', authenticateToken, bookingController.createBooking); // Create booking
...
router.get('/bookings', authenticateToken, bookingController.getAllBookings); // Get all bookings with filters
